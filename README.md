...
|1주(5/20~5/26)|시간, 분, 초 및 간단한 버튼을 이용한 기본 동작 구현완료|
|2주(5/27~6/2)|하드웨어 납땜작업 및 작동여부 확인, 중간발표 준비 및 발표|
|3주(6/3~6/9)|하드웨어 납땜 마무리 및 추가기능(시간설정, 정각알림) 구현|
|4주(6/10~6/17)|추가 기능 구현|
